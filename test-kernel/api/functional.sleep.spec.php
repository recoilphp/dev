...
context('api/sleep', function () {
    it('resumes execution after the specified number of seconds', function () {
    ...
    it('can be invoked by yielding a number', function () {
        $time = microtime(true);
        yield 0.02;
        $diff = microtime(true) - $time;
    ...
    it('wakes strands in the correct order', function () {
